...
cp openvidu-browser/static/js/openvidu-browser-"$1".min.js ../openvidu-tutorials/openvidu-hello-world/web/openvidu-browser-"$1".min.js
...
cp openvidu-browser/static/js/openvidu-browser-"$1".min.js ../openvidu-tutorials/openvidu-recording-java/src/main/resources/static/openvidu-browser-"$1".min.js

# openvidu-recording-node
cp openvidu-browser/static/js/openvidu-browser-"$1".min.js ../openvidu-tutorials/openvidu-recording-node/public/openvidu-browser-"$1".min.js
